...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]Vinhhhh
[FFD700]✨ tiktok : [FFFFFF] dvihn_1❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> DVIHN❄️  ⚡
"""
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "TVINH", key, iv)
                        ...
                        if inPuTMsG.strip().startswith('/rd'):
                            ...
                            # Always use the sender's UID (the person who typed /rd)
                            ...
                            if len(parts) > 1:
                                for part in parts[1:]:  # Skip the first part which is "/rd"
                        ...
                        # EVO CYCLE STOP COMMAND - /srd
                        if inPuTMsG.strip() == '/srd':
                            if evo_cycle_task and not evo_cycle_task.done():
                                evo_cycle_running = False
                                evo_cycle_task.cancel()
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To ᴋᴀʟʟᴜ ˣ ʙᴏᴛ"
...
├─ [00FFFF]Tạo Team 3-Nhóm
│  └─ [FF69B4]/3
├─ [00FFFF]Tạo Team 5-Nhóm
│  └─ [FF69B4]/5
├─ [00FFFF]Tạo Team 6-Nhóm
│  └─ [FF69B4]/6
├─ [00FFFF]Mời Người chơi
│  └─ [FF69B4]/inv [uid]
├─ [00FFFF]Bot Vào Team
│  └─ [FF69B4]/join [team_code]
├─ [00FFFF]Thoát Nhóm ( Cho Bot )
│  └─ [FF69B4]/exit
└─ [00FFFF]Bắt Đầu Trận
   └─ [FF69B4]/start
[00FFFF]━━━━━━━━━━━━[FF69B4]"""
...
├─ [FF1493]Spam Lời Mời ( 30 Lần
│  └─ [BA55D3]/spm_inv [uid]
├─ [FF1493]Ngừng Spam Mời
│  └─ [BA55D3]/stop spm_inv
├─ [FF1493]Vào Team Tàng Hình
│  └─ [BA55D3]/ghost [code]
├─ [FF1493]Lag Team Code
│  └─ [BA55D3]/lag [code]
├─ [FF1493]Ngừng Làm Lag
│  └─ [BA55D3]/stop lag
└─ [FF1493]Từ Chối Spam
   └─ [BA55D3]/reject [uid]
[FF1493]━━━━━━━━━━━━[BA55D3]"""
...
├─ [7CFC00]Gửi 1 Hành Động
│  └─ [32CD32]/e [uid] [id]
├─ [7CFC00]Làm HĐ Nhanh (21 Lần)
│  └─ [32CD32]/fast [uid] [id]
└─ [7CFC00]Chỉnh Hành Động(X Thời Gian)
   └─ [32CD32]/p [uid] [id] [x]
[7CFC00]━━━━━━━━━━━━[32CD32]"""
...
├─ [FF6347]Hành Động Tiến Hoá
│  └─ [FFA500]/evo [uid] [1-21]
├─ [FF6347]Hành Động Nhanh (21 Lần)
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]VINHHHHH
...
async def MaiiiinE():
    Uid , Pw = '4317172439','1E06CA37C8635D5228FBA0B6B40AD5995CA1526031518AE652FC00EAFDA2AB23'
    ...
    os.system('clear')
    print(render('CACs', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 vinh BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using VINHBOT")
    sys.exit(0)
